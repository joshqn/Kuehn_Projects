class ProjectsController < ApplicationController
  ...
  # GET /:type
  def type
    @projects = Project.where("projType = ?", params[:type]).paginate(page: params[:page], :per_page => 3)
    render :index
  end
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:title, :description, :projType,:projImage, :name)
    end
end
